                        ...
                        <div className="flex items-start justify-between gap-3 mb-4">
                            <div className="flex items-center gap-2.5">
                                <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0"
                                    ...
                                    <span className="material-symbols-outlined" style={{ color: '#732c7c', fontSize: '1.1rem' }}>cookie</span>
                                </div>
                                ...
                                >
                                    <div className="mb-4 space-y-2.5 pt-1">
                                        ...
                                        <div className="flex items-center justify-between p-3 rounded-xl"
                                            ...
                                            <div>
                                                <p className="font-headline font-bold text-xs" style={{ color: '#1a0a2e' }}>Essential</p>
                                                <p className="text-[11px]" style={{ color: '#8a6fa0' }}>Required for the site to work</p>
                                            </div>
                                            {/* Always on toggle */}
                                            <div className="w-9 h-5 rounded-full flex items-center justify-end pr-0.5 flex-shrink-0"
                                        ...
                                        <div className="flex items-center justify-between p-3 rounded-xl"
                                            style={{ background: 'rgba(115,44,124,0.05)', border: '1px solid rgba(115,44,124,0.10)' }}>
                                            <div>
                                                <p className="font-headline font-bold text-xs" style={{ color: '#1a0a2e' }}>Analytics</p>
                                                <p className="text-[11px]" style={{ color: '#8a6fa0' }}>Help us understand site usage</p>
                                            </div>
                                            <button
                                                onClick={() => setPrefs(p => ({ ...p, analytics: !p.analytics }))}
                                                className="w-9 h-5 rounded-full flex items-center flex-shrink-0 transition-all duration-300 relative"
                                                style={{ background: prefs.analytics ? '#732c7c' : 'rgba(115,44,124,0.15)' }}
                                            >
                                                <motion.div
                                        ...
                                        <div className="flex items-center justify-between p-3 rounded-xl"
                                            style={{ background: 'rgba(115,44,124,0.05)', border: '1px solid rgba(115,44,124,0.10)' }}>
                                            <div>
                                                <p className="font-headline font-bold text-xs" style={{ color: '#1a0a2e' }}>Marketing</p>
                                                <p className="text-[11px]" style={{ color: '#8a6fa0' }}>Personalised ads & content</p>
                                            </div>
                                            <button
                                                onClick={() => setPrefs(p => ({ ...p, marketing: !p.marketing }))}
                                                className="w-9 h-5 rounded-full flex items-center flex-shrink-0 transition-all duration-300 relative"
                                                style={{ background: prefs.marketing ? '#732c7c' : 'rgba(115,44,124,0.15)' }}
                                            >
                                                <motion.div
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    onMouseOver={e => { e.currentTarget.style.background = 'rgba(115,44,124,0.07)'; e.currentTarget.style.borderColor = 'rgba(115,44,124,0.60)' }}
                                    onMouseOut={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.borderColor = 'rgba(115,44,124,0.30)' }}
                                >
                                ...
                                <button
                                    ...
                                    onMouseOver={e => { e.currentTarget.style.borderColor = 'rgba(115,44,124,0.35)'; e.currentTarget.style.color = '#4a3560' }}
                                    onMouseOut={e => { e.currentTarget.style.borderColor = 'rgba(115,44,124,0.15)'; e.currentTarget.style.color = '#8a6fa0' }}
                                >
                                    Essential Only
                                </button>
                            </div>
