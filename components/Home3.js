...
const WHO_WE_ARE_POINTS = [
  {
    icon: "hub",
    title: "Built as a Growth System",
    desc: "Every service connects with the others creating a compounding growth engine that gets stronger over time.",
  },
  {
    icon: "robot_2",
    title: "Powered by AI Automation",
    desc: "Advanced AI tools integrated into our workflows from intelligent content systems to automated ad optimisation.",
  },
  {
    icon: "psychology",
    title: "Guided by Real Expertise",
    desc: "AI gives us speed and precision. Our people give it strategy and direction backed by deep experience.",
  },
];
...
const AI_BULLETS = [
  {
    icon: "ads_click",
    title: "Intelligent Ad Optimisation",
    desc: "Real time bidding, audience refinement, and budget allocation automated and always improving.",
  },
  {
    icon: "auto_awesome",
    title: "AI Content Systems",
    desc: "From ideation to scheduling, AI accelerates our content pipeline without compromising quality.",
  },
  {
    icon: "analytics",
    title: "Predictive Analytics",
    desc: "We use AI to forecast campaign performance, identify trends early, and stay ahead of the curve.",
  },
  {
    icon: "dashboard",
    title: "Automated Reporting",
    desc: "Clear, real time dashboards that surface what's working no manual pulling, no delays.",
  },
];
...
const SERVICES = [
  {
    ...
    desc: "We build genuine communities around your brand through strategic content, platform native storytelling, and consistent engagement that turns followers into loyal customers and brand advocates.",
    tag: "AI Scheduling & Insights",
  },
  {
    num: "02",
    icon: "search_insights",
    title: "SEO & Content Marketing",
    desc: "Long term visibility that compounds over time. We craft content strategies and search frameworks that earn organic rankings, build topical authority, and bring the right audiences to you consistently.",
    tag: "AI SEO Research",
  },
  {
    num: "03",
    ...
    desc: "Strategic, data driven campaigns across Google, Meta, and beyond where every pound spent is purposeful, every audience is carefully defined, and performance is monitored and improved continuously.",
    tag: "AI Bid Optimisation",
  },
  {
    num: "04",
    icon: "palette",
    title: "Branding & Creative Design",
    desc: "A brand that means something is one of the most valuable assets a business can have. We build thoughtful, distinctive identities visual systems, messaging, and brand strategy that earns recognition and trust.",
    tag: "AI Assisted Concepting",
  },
  {
    num: "05",
    icon: "web",
    title: "Web Design & Development",
    desc: "Beautiful, high converting websites that work as hard as you do. We design and develop digital experiences that reflect your brand's quality, perform flawlessly, and guide visitors naturally towards action.",
    tag: "AI UX Personalisation",
  },
  {
    num: "06",
    icon: "videocam",
    title: "Video Production & Editing",
    desc: "From brand story films to short form social content, we produce video that captures attention and communicates your value with clarity. Concept to final edit handled entirely in house, enhanced by AI tools.",
    tag: "AI Video Enhancement",
  },
];
...
const PROCESS = [
  {
    ...
    desc: "Thorough analysis of your brand, market, competitors, and current performance before we make a single move.",
  },
  {
    num: "02",
    title: "Strategy & Planning",
    desc: "A tailored, integrated growth strategy connecting every channel toward your specific business goals.",
  },
  {
    num: "03",
    title: "Execute & Automate",
    desc: "Our team launches campaigns with AI automation running in the background keeping everything optimised.",
  },
  {
    num: "04",
    title: "Measure & Scale",
    desc: "We track what matters, report with transparency, and scale the strategies that work into long term growth.",
  },
];
...
const VALUES = [
  {
    num: "01",
    title: "Growth Should Be Sustainable",
    desc: "We're not interested in quick wins that fade. Every strategy we build is designed for the long run creating momentum that compounds over time and delivers returns that grow stronger the further you go.",
  },
  {
    num: "02",
    title: "Automation Should Serve People",
    desc: "AI and automation are powerful tools but they work best when guided by human understanding and empathy. We use intelligent systems to handle the heavy lifting, so our team can focus on what matters most: your goals, your audience, and your story.",
  },
  {
    num: "03",
    title: "Transparency Builds Trust",
    desc: "We believe great partnerships are built on honesty. You'll always know what we're working on, why we're doing it, and what it's delivering. Our reporting is clear, our communication is open, and we'll always tell you the truth.",
  },
  {
    num: "04",
    title: "Every Brand Deserves Craft",
    desc: "Whether you're a small business finding your voice or an established brand refining it, we bring the same level of care and attention to every project. Great work isn't reserved for big budgets it's a standard we hold for every client we work with.",
  },
  {
    num: "05",
    title: "Partnership Over Transactional",
    desc: "We don't think of ourselves as a vendor. We show up as a genuine partner invested in your success, curious about your challenges, and committed to being the kind of team you're genuinely glad to have in your corner.",
  },
];
...
function Divider() {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg,transparent,rgba(115,44,124,0.28),rgba(209,116,109,0.18),transparent)",
      }}
    />
  );
}
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              >
                ...
                >
                  Webxautomation is a{" "}
                  <span style={{ color: "#D6008D", fontWeight: 700 }}>
                    full service digital agency
                  </span>{" "}
                  that helps businesses grow smarter not just faster. We combine
                  proven marketing expertise with cutting-edge AI automation to
                  build sustainable growth systems that work for your brand
                  around the clock.
                </p>
                <p
                  ...
                  style={{ color: "#ffffff" }}
                >
                  From the first impression to the final conversion, every
                  touchpoint we create is thoughtfully designed, strategically
                  powered, and continuously optimised so your business keeps
                  moving forward, even when you&apos;re not at your desk.
                </p>
              </motion.div>
      ...
      <div
        ...
        style={{
          ...
          borderTop: "1px solid rgba(115,44,124,0.12)",
          borderBottom: "1px solid rgba(115,44,124,0.12)",
        }}
      >
        <div className="flex gap-12 animate-marquee whitespace-nowrap">
          {[...MARQUEE_ITEMS, ...MARQUEE_ITEMS].map((item, i) => (
            <span
              key={i}
              className="flex items-center gap-3 text-sm font-headline font-bold uppercase tracking-widest"
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-card mb-8">
              <span
                ...
                style={{ color: "#D6008D", fontVariationSettings: "'FILL' 1" }}
              >
                groups
              </span>
              <span
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            <div>
              <FadeIn delay={0.08}>
                <h2
                  className="font-headline font-black tracking-tight leading-[0.9] mb-8"
                  style={{
              ...
              <FadeIn delay={0.14}>
                ...
                >
                  ...
                  <span style={{ color: "#D6008D", fontWeight: 600 }}>
                    businesses deserve a marketing partner that genuinely cares
                    about their growth
                  </span>{" "}
                  not just their monthly retainer. So we built an agency where
                  every strategy, every campaign, and every creative decision is
                  made with your longterm success in mind.
                </p>
              </FadeIn>
              <FadeIn delay={0.18}>
                <p
                  ...
                  style={{ color: "#ffffff" }}
                >
                  Our team brings together experienced strategists, talented
                  creatives, and performance focused marketers who&apos;ve
                  worked across industries, budgets, and growth stages.
                  We&apos;ve helped businesses launch from zero, scale past
                  their ceilings, and reimagine what their brand can be and we
                  bring that same dedication to every new partnership we form.
                </p>
              </FadeIn>
              <FadeIn delay={0.22}>
                <p
                ...
                >
                  ...
                  <span style={{ color: "#D6008D", fontWeight: 600 }}>
                    human insight with intelligent automation
                  </span>
                  . We&apos;ve built AI powered systems into the core of how we
                  work accelerating research, sharpening targeting, streamlining
                  content production, and optimising campaigns in real time so
                  you get the benefit of enterprise-level capability, whatever
                  your size.
                </p>
              </FadeIn>
              <FadeIn delay={0.26}>
                <p
                  ...
                  style={{ color: "#ffffff" }}
                >
                  At Webxautomation, we don&apos;t just run your marketing. We
                  build a{" "}
                  <span style={{ color: "#D6008D", fontWeight: 600 }}>
                    growth infrastructure
                  </span>{" "}
                  that compounds over time one that brings more visibility, more
                  engagement, and more revenue as every layer builds on the
                  last.
                </p>
              </FadeIn>
            </div>
                ...
                {WHO_WE_ARE_POINTS.map((p, i) => (
                  <FadeIn key={p.title} delay={0.1 + i * 0.1}>
                    ...
                    >
                      ...
                      <div>
                        <h3
                          className="font-headline font-black text-base mb-2"
                          style={{ color: "#ffffffff" }}
                        >
                          {p.title}
                        </h3>
      ...
      <section className="relative z-10 py-24 px-5 md:px-10 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 50%, rgba(209,116,109,0.08) 0%, transparent 65%)",
          }}
        />
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              <FadeIn delay={0.08}>
                <h2
                  className="font-headline font-black tracking-tight leading-[0.9] mb-6"
                  style={{
                    fontSize: "clamp(2.2rem,4.5vw,4rem)",
                    color: "#ffffff",
                  }}
              ...
              <FadeIn delay={0.14}>
                <p
                  ...
                  style={{ color: "#ffffff" }}
                >
                  We don&apos;t use AI as a gimmick. We&apos;ve embedded
                  intelligent automation into the heart of our agency so every
                  campaign runs leaner, every decision is better informed, and
                  every result is achieved faster.
                </p>
              </FadeIn>
              <FadeIn delay={0.2}>
                <div
                  ...
                  style={{
                    background: "rgba(115,44,124,0.06)",
                    border: "1px solid rgba(115,44,124,0.18)",
                  }}
                >
                  <p
                    className="font-headline font-black text-base mb-3"
                    style={{ color: "#D6008D" }}
                  >
                    Your Growth System, Running 24/7
                  </p>
                  <p
                    className="text-sm leading-relaxed"
                    style={{ color: "#ffffff" }}
                  >
                    ...
                    , and surfacing the insights that matter most for your next
                    move.
                  </p>
                </div>
              </FadeIn>
              <FadeIn delay={0.24}>
                <p
                  ...
                  style={{ color: "#ffffff" }}
                >
                  We&apos;ve built automation pipelines that eliminate the
                  repetitive, time consuming tasks that slow most marketing
                  teams down freeing up our strategists to focus entirely on the
                  creative and strategic work that moves the needle.
                </p>
              </FadeIn>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {AI_BULLETS.map((b, i) => (
                <FadeIn key={b.title} delay={0.08 + i * 0.09}>
                  ...
                  <motion.div
                    whileHover={{ y: -6, borderColor: "rgba(115,44,124,0.4)" }}
                    transition={{ duration: 0.25 }}
                    className="about-card p-6 h-full"
                  >
                    <motion.div
                    ...
                    >
                      <span
                        className="material-symbols-outlined"
                        style={{ color: "#D6008D", fontSize: "1.2rem" }}
                      >
                        {b.icon}
                      </span>
                    </motion.div>
                    <h3
                      className="font-headline font-black text-sm mb-2"
                      style={{ color: "#ffffffff" }}
                    >
                      {b.title}
                    </h3>
      ...
      <section className="relative z-10 py-24 px-5 md:px-10 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 0% 60%, rgba(115,44,124,0.07) 0%, transparent 55%)",
          }}
        />
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-start">
            <div>
              ...
              <FadeIn delay={0.08}>
                <h2
                  className="font-headline font-black tracking-tight leading-[0.9] mb-4"
                  style={{
                    fontSize: "clamp(2.2rem,4.5vw,4rem)",
                    color: "#ffffff",
                  }}
              ...
              <FadeIn delay={0.14}>
                <p
                  ...
                  style={{ color: "#ffffff" }}
                >
                  We follow a structured, proven process designed to remove
                  guesswork and create clarity at every stage. Here&apos;s how
                  we turn your goals into a growth system that delivers.
                </p>
              </FadeIn>
              <FadeIn delay={0.18}>
                <p
                  className="text-xs font-headline font-bold uppercase tracking-widest mb-12"
                  style={{ color: "#D6008D" }}
                >
                  The Webxautomation Growth Framework A four phase approach to
                  building sustainable, compounding growth for your business.
                </p>
              </FadeIn>
            </div>
            <div>
          ...
          <FadeIn>
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 50% 0%,rgba(115,44,124,0.12),transparent 55%)",
                }}
              />
              <div
                className="absolute inset-0 pointer-events-none"
                style={{
                  background:
                    "radial-gradient(ellipse at 50% 100%,rgba(209,116,109,0.08),transparent 55%)",
                }}
              />
              <div className="relative z-10">
                <p
                  className="text-xs font-headline font-bold uppercase tracking-widest mb-6"
                  style={{ color: "#D6008D" }}
                >
                  The Webxautomation Belief
                </p>
                <h2
                  className="font-headline font-black tracking-tight leading-tight mb-8"
                  style={{
                ...
                <p
                  ...
                  style={{ color: "#ffffffff" }}
                >
                  The most successful brands aren&apos;t the ones that ran the
                  cleverest ad or went viral once. They&apos;re the ones that
                  built a connected, intelligent marketing infrastructure that
                  kept delivering month after month, year after year.
                  That&apos;s what Webxautomation exists to create for you.
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="relative z-10 py-24 px-5 md:px-10">
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 50% -5%,rgba(115,44,124,0.18),transparent 55%)",
                }}
              />
              <motion.div
              ...
              <div className="relative z-10">
                <h2
                  className="font-headline font-black tracking-tight leading-tight mb-6"
                  style={{
                ...
                <p
                  ...
                  style={{ color: "#ffffffff" }}
                >
                  Whether you&apos;re launching something new or scaling
                  something proven, Webxautomation has the strategy, the tools,
                  and the team to take you there. Let&apos;s start the
                  conversation.
                </p>
          ...
          <FadeIn delay={0.1}>
            <p
              className="text-center text-xs font-headline font-bold mt-8"
              style={{ color: "#ffffff" }}
            >
              WEBXAUTOMATION · Digital Growth & AI Automation Agency ·
              webxautomation.in
            </p>
          </FadeIn>
        </div>
