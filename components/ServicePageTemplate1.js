    ...
    return (
        <section className="py-20 px-5 md:px-10 relative" style={{ zIndex: 1 }}>
            <div className="max-w-4xl mx-auto">
                <FadeIn>
                    <p className="font-headline font-bold tracking-widest uppercase text-xs mb-3" style={{ color: '#732c7c' }}>FAQs</p>
                    <h2 className="font-headline font-black mb-12" style={{ fontSize: 'clamp(1.8rem,3vw,2.8rem)', color: '#1a0a2e' }}>
                        ...
                        <FadeIn key={i} delay={i * 0.06}>
                            <motion.div
                                ...
                                style={{
                                    ...
                                    border: open === i ? '1px solid rgba(115,44,124,0.35)' : '1px solid rgba(115,44,124,0.12)',
                            ...
                            >
                                ...
                                >
                                    <span className="font-headline font-bold text-base md:text-lg leading-snug" style={{ color: '#1a0a2e' }}>
                                        {faq.q}
                                    </span>
                                    <motion.span
                                        ...
                                        style={{ color: '#732c7c', fontSize: '1.4rem' }}
                                    >
                                        add
                                    </motion.span>
                                </button>
                                ...
                                >
                                    <p className="px-6 pb-6 text-sm leading-relaxed" style={{ color: '#4a3560' }}>
                                        {faq.a}
                                    </p>
                                </motion.div>
                            </motion.div>
...
export default function ServicePageTemplate({ service }) {
    return (
        ...
        .spt-process-step:hover {
          border-color: rgba(115,44,124,0.35);
          transform: translateY(-6px);
        ...
        .spt-stack-pill {
          background: rgba(243,238,249,0.95);
          border: 1px solid rgba(115,44,124,0.14);
      ...
      `}</style>
            ...
            <section className="relative pt-36 pb-20 px-5 md:px-10 overflow-hidden" style={{ zIndex: 1 }}>
                ...
                <div className="max-w-7xl mx-auto">
                    {/* Back link */}
                    <FadeIn>
                        <Link href="/services" className="inline-flex items-center gap-2 text-sm font-headline font-bold mb-10 transition-colors" style={{ color: '#ffffffff' }}>
                            ...
                            <FadeIn key={feat.title} delay={i * 0.07}>
                                <div className="spt-card p-7 h-full flex flex-col">
                                    <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5 flex-shrink-0"
                                        style={{ background: 'rgba(115,44,124,0.09)', border: '1px solid rgba(115,44,124,0.18)' }}>
                                        <span className="material-symbols-outlined" style={{ color: '#732c7c', fontSize: '1.3rem' }}>{feat.icon}</span>
                                    </div>
                                    <h3 className="font-headline font-black text-base mb-2" style={{ color: '#1a0a2e' }}>{feat.title}</h3>
                                    <p className="text-sm leading-relaxed" style={{ color: '#4a3560' }}>{feat.desc}</p>
                                </div>
                            </FadeIn>
                        ))}
                    </div>
                            ...
                            <FadeIn key={step.title} delay={i * 0.1}>
                                <div className="spt-process-step p-8 h-full flex flex-col">
                                    <div className="flex items-center gap-3 mb-5">
                                        <span className="font-headline font-black text-4xl" style={{ color: 'rgba(115,44,124,0.4)' }}>
                                            {String(i + 1).padStart(2, '0')}
                                        </span>
                                        <span className="material-symbols-outlined text-base" style={{ color: 'rgba(115,44,124,0.4)' }}>arrow_forward</span>
                                    </div>
                                    <h3 className="font-headline font-black text-base mb-3" style={{ color: '#1a0a2e' }}>{step.title}</h3>
                                    <p className="text-sm leading-relaxed flex-1" style={{ color: '#4a3560' }}>{step.desc}</p>
                                </div>
                            </FadeIn>
                        ))}
                    </div>
                            ...
                            <FadeIn key={r.label} delay={i * 0.08}>
                                <div className="spt-result-card p-8 text-center">
                                    <p className="font-headline font-black mb-2"
                                        style={{ fontSize: 'clamp(2.2rem,4vw,3.2rem)', background: 'linear-gradient(135deg,#732c7c,#d1746d,#f6a16c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                                        {r.val}
                                    </p>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {service.stack.map((tech, i) => (
                                    <FadeIn key={tech} delay={i * 0.04}>
                                        <span className="spt-stack-pill px-5 py-2.5 text-sm font-headline font-bold" style={{ color: '#43175f' }}>
                                            {tech}
                                        </span>
                                    </FadeIn>
                                ))}
            ...
            <section className="py-24 px-5 md:px-10 relative" style={{ zIndex: 1 }}>
                <FadeIn>
                    <div className="max-w-4xl mx-auto text-center rounded-3xl p-10 md:p-16 relative overflow-hidden"
                        style={{ background: 'rgba(243,238,249,0.95)', border: '1px solid rgba(115,44,124,0.22)' }}>
                        ...
                        <motion.div
                            ...
                            style={{ background: 'rgba(115,44,124,0.10)', border: '1px solid rgba(115,44,124,0.22)' }}>
                            <span className="material-symbols-outlined text-2xl" style={{ color: '#732c7c', fontVariationSettings: "'FILL' 1" }}>
                                flash_on
                            </span>
                        </motion.div>
                        <h2 className="font-headline font-black tracking-tight leading-tight mb-5 relative z-10"
                            style={{ fontSize: 'clamp(1.8rem,3.5vw,3rem)', color: '#1a0a2e' }}>
                        ...
                        <p className="mb-10 relative z-10 max-w-xl mx-auto" style={{ color: '#4a3560' }}>
                            Let&apos;s build something extraordinary together. No pressure just a conversation.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4 relative z-10">
                            <Link href="/contact">
                                <button style={{ background: 'linear-gradient(135deg,#732c7c,#43175f)', color: '#fff', fontFamily: 'inherit', fontWeight: 700, borderRadius: '9999px', border: 'none', padding: '16px 40px', fontSize: '1rem', cursor: 'pointer', boxShadow: '0 0 24px rgba(115,44,124,0.35)', transition: 'opacity 0.2s, transform 0.2s' }}
                            ...
                            <Link href="/services">
                                <button style={{ border: '1.5px solid rgba(115,44,124,0.38)', color: '#43175f', fontFamily: 'inherit', fontWeight: 700, borderRadius: '9999px', background: 'transparent', padding: '16px 40px', fontSize: '1rem', cursor: 'pointer', transition: 'all 0.25s ease' }}
                                    onMouseOver={e => { e.currentTarget.style.background = 'rgba(115,44,124,0.07)'; e.currentTarget.style.borderColor = 'rgba(115,44,124,0.7)' }}
                                    onMouseOut={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.borderColor = 'rgba(115,44,124,0.38)' }}>
                                    All Services
                                </button>
                            </Link>
                        </div>
